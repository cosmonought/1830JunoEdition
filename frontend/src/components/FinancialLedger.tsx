...
const styles: Record<string, React.CSSProperties> = {
  ...
  depotPhase: { fontSize: FONT_SIZE.small, color: "#c8c6c0", fontWeight: 700 },
  ...
  depotNone: { fontSize: FONT_SIZE.small, color: "#6e6c68" },
  depotTrigger: { color: "#a8a6a0" },
  depotRustedBadge: {
    marginLeft: "8px",
    fontSize: FONT_SIZE.micro,
    fontWeight: 800,
  ...
  holdingsEmpty: { color: "#6e6c68", fontStyle: "italic" },
  footnote: {
    fontSize: FONT_SIZE.micro,
    color: "#6e6c68",
    margin: 0,
