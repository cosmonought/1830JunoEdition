...
const styles: Record<string, React.CSSProperties> = {
  ...
  headerHint: { fontSize: FONT_SIZE.small, color: "#8a8a86" },
  ...
  offerText: { flex: 1, fontSize: FONT_SIZE.body, lineHeight: 1.5, color: "#c8c6c0" },
  ...
  waitingNote: { fontSize: FONT_SIZE.small, color: "#6e6c68" },
  warn: { fontSize: FONT_SIZE.small, color: "#c8a24a" },
  note: { fontSize: FONT_SIZE.small, lineHeight: 1.5, color: "#8a8a86" },
};
