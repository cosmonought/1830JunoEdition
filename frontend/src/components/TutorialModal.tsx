...
const styles: Record<string, React.CSSProperties> = {
  ...
  stepCount: { fontSize: FONT_SIZE.small, color: "#8a8a86", fontVariantNumeric: "tabular-nums" },
  body: {
    display: "flex",
    flexDirection: "column",
    gap: "6px",
  ...
  pageBody: { margin: 0, fontSize: FONT_SIZE.body, lineHeight: LINE_HEIGHT.normal, color: "#c8c6c0" },
